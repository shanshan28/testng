...
public class DemoApplicationTests {
    ...
    /**
     * getUseBikePagePrimeInfo接口请求数据提供
     * @throws Exception
     */
    @DataProvider(name = "getUseBikePagePrimeInfo_dataProvider")
    public Object[] getUseBikePagePrimeInfo_dataProvider() {
        //根据请求参数所在路径获取对应的请求数据
        String filePath = fileRead(
                "src/test/java/com/hellobike/test/request/getUseBikePagePrimeInfo.json");
    ...
    /**
     * getUseBikePagePrimeInfoTest
     * @param bodyJson
     * @throws Exception
     */
    @Test(dataProvider = "getUseBikePagePrimeInfo_dataProvider")
    public void getUseBikePagePrimeInfoTest(JSONObject bodyJson) throws Exception {
        ...
        try {
            ...
            String filePath = "src/test/java/com/hellobike/test/response/getUseBikePagePrimeInfo_tt.json";
