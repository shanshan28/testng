...
public class getOrderList {
     ...
     * @throws Exception
     */
    @DataProvider(name = "getOrderList_dataProvider")
    public Object[] getOrderList_dataProvider() {
        //根据请求参数所在路径获取对应的请求数据
     ...
     * @throws Exception
     */
    @Test(dataProvider = "getOrderList_dataProvider")
    public void getOrderList(JSONObject bodyJson) throws Exception {
