...
public class ContractBikeSkuTest {

    /**
     * contractBikeSku接口请求数据提供
     * @throws Exception
     */
    @DataProvider(name = "contractBikeSkuTest_dataProvider")
    public Object[] contractBikeSkuTest_dataProvider() {
        //根据请求参数所在路径获取对应的请求数据
        String filePath = fileRead(
                "src/test/java/com/hellobike/test/request/contractBikeSku.json");
     ...
     * @throws Exception
     */
    @Test(dataProvider = "contractBikeSkuTest_dataProvider")
    public void contractBikeSkuTest(JSONObject bodyJson) throws Exception {
        ...
        try {
            ...
            String filePath = "src/test/java/com/hellobike/test/response/contractBikeSku_tt.json";
